    ...
    >
      <div className="grid md:grid-cols-12 gap-10 md:gap-20 items-center">
        ...
        <div className="md:col-span-6 order-1">
          ...
          <h1 className={`${locale === "ko" ? "hero-slide-heading-ko " : locale === "zh" ? "hero-slide-heading-zh " : ""}hero-slide-heading font-serif text-[34px] sm:text-[44px] md:text-[64px] leading-[1.08] tracking-[-0.018em] text-ink mt-6 md:mt-8 font-semibold`}>
