...
export function Footer() {
  ...
  const popularToursByLocale = {
    en: [
      ...
      { l: "Las Vegas & Canyons 4-Day Tour", to: lp("/tours/vegas-canyons-4-day") },
    ...
    zh: [
      ...
      { l: "拉斯維加斯與大峽谷四日遊", to: lp("/tours/vegas-canyons-4-day") },
    ...
    ko: [
      ...
      { l: "라스베이거스 & 캐니언 4일 투어", to: lp("/tours/vegas-canyons-4-day") },
