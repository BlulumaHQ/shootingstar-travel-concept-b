...
const ZH: IcefieldsContent = {
  ...
  products: {
    P1: { id: "P1", name: "班夫前往賈斯珀觀光接駁", short: "沿冰原大道北上的全日觀光接駁。", days: ["Mon","Fri"], daysLabel: "週一 / 週五", direction: "班夫 → 賈斯珀", time: "08:00 – 17:10（含 Hinton 至 18:30）", durationHrs: "約 9 小時", adult: 200, child: 140, childAvailable: true, addOns: ["CBI","HINTON_ONE","HINTON_ROUND"], bestFor: "從班夫前往賈斯珀的觀光接駁", schedule: ["08:00 — Moxy Banff 飯店接送","08:03 — Best Western 接送","08:10 — Mountain Royal 接送","17:10 — 賈斯珀火車站下車","18:30 — Hinton 下車（含延伸）"], accent: "north" },
    P2A: { id: "P2A", name: "賈斯珀 & 瑪琳湖精靈島一日遊", short: "以賈斯珀為基地，前往藥湖與瑪琳湖。", days: ["Tue","Sat"], daysLabel: "週二 / 週六", direction: "Hinton / 賈斯珀 → 瑪琳湖 → 賈斯珀", time: "09:20 – 16:40", durationHrs: "約 5 小時", adult: 160, child: 160, childAvailable: false, addOns: ["CRUISE"], bestFor: "賈斯珀與精靈島一日遊", schedule: ["09:20 — Hinton 接送","10:30 – 11:20 — 賈斯珀小鎮 / 金字塔湖","11:40 — 賈斯珀車站接送","12:20 – 12:50 — 藥湖停靠","13:20 – 15:30 — 瑪琳湖 / 精靈島核心體驗","16:40 — 賈斯珀車站下車"], accent: "split" },
    P2B: { id: "P2B", name: "賈斯珀往班夫快速接駁", short: "傍晚南下快速接駁,無觀光停點。", days: ["Tue","Sat"], daysLabel: "週二 / 週六", direction: "賈斯珀 → 班夫", time: "17:00 – 22:00", durationHrs: "約 5 小時", adult: 130, child: 130, childAvailable: false, addOns: [], bestFor: "傍晚從賈斯珀回到班夫的接駁", schedule: ["16:40 — 賈斯珀車站登車 / 轉乘","17:00 — 賈斯珀出發","中途僅停靠洗手間（不接送）","21:30 — Mountain Royal 飯店或班夫鎮指定飯店下車","22:00 — 預計抵達終點"], accent: "split" },
    P3A: { id: "P3A", name: "班夫往賈斯珀快速接駁", short: "上午北上快速接駁,僅停靠洗手間。", days: ["Tue","Sat"], daysLabel: "週二 / 週六", direction: "班夫 → 賈斯珀", time: "08:00 – 13:00", durationHrs: "約 5 小時", adult: 130, child: 130, childAvailable: false, addOns: ["HINTON_ONE","HINTON_ROUND"], bestFor: "從班夫快速前往賈斯珀的接駁", schedule: ["08:00 — Moxy Banff 飯店接送","08:03 — Best Western 接送","08:10 — Mountain Royal 接送","中途僅停靠洗手間","13:00 — 賈斯珀車站下車"], accent: "split" },
    P3B: { id: "P3B", name: "賈斯珀藥湖 & 瑪琳湖半日遊", short: "下午以賈斯珀為基地的湖區半日觀光。", days: ["Tue","Sat"], daysLabel: "週二 / 週六", direction: "賈斯珀 → 藥湖 → 瑪琳湖 → 賈斯珀", time: "13:00 – 18:00", durationHrs: "約 5 小時", adult: 160, child: 160, childAvailable: false, addOns: ["CRUISE","HINTON_ONE","HINTON_ROUND"], bestFor: "賈斯珀湖區半日觀光", schedule: ["13:00 — 賈斯珀車站接送","13:30 – 14:30 — 藥湖停靠","15:00 – 17:00 — 瑪琳湖遊船 / 核心湖區體驗","18:00 — 賈斯珀車站下車"], accent: "split" },
    P4: { id: "P4", name: "冰原大道南下觀光接駁", short: "沿冰原大道南下的全日觀光接駁。", days: ["Wed","Sun"], daysLabel: "週三 / 週日", direction: "賈斯珀 → 班夫", time: "09:00 – 18:50", durationHrs: "約 10 小時", adult: 220, child: 160, childAvailable: true, addOns: ["CBI","HINTON_ONE","HINTON_ROUND"], bestFor: "南下冰原大道全日觀光", schedule: ["07:50 — Hinton 接送（加購)","09:00 — 賈斯珀車站接送","09:30 – 10:10 — 阿薩巴斯卡瀑布","11:10 – 14:40 — 哥倫比亞冰原中心","15:40 – 17:00 — 佩托湖","17:10 – 17:40 — 弓湖","18:50 — Mountain Royal 飯店或班夫鎮指定飯店下車"], accent: "south" },
  },
  addOns: {
  ...
  pickups: ["Moxy Banff 飯店 (08:00)","Best Western Banff (08:03)","Mountain Royal Banff (08:10)","賈斯珀火車站","Hinton（需加購)"],
  dropoffs: ["賈斯珀火車站","Mountain Royal Banff","班夫鎮指定飯店","Hinton（需加購)"],
  meta: {
    title: "冰原大道、賈斯珀、班夫與瑪琳湖接駁觀光｜流星雨假期",
    description: "靈活的洛磯山觀光接駁,串聯班夫、賈斯珀、Hinton、哥倫比亞冰原、藥湖與瑪琳湖。依星期安排的路線、可加購的景點門票與清楚的接送地點。",
    ogTitle: "冰原大道、賈斯珀、班夫與瑪琳湖接駁觀光",
    ogDescription: "以星期為基準的洛磯山接駁,班夫、賈斯珀、Hinton、哥倫比亞冰原與瑪琳湖,加購選項與清楚的預估金額。",
  },
  hero: {
    eyebrow: "— 加拿大洛磯山 · 接駁與觀光",
    h1: "冰原大道、賈斯珀、班夫 & 瑪琳湖接駁觀光",
    sub: "串聯班夫、賈斯珀、Hinton、哥倫比亞冰原、藥湖與瑪琳湖的彈性觀光接駁,依星期安排路線,可加購景點門票,接送地點清楚明確。",
    ctaReserve: "預約路線 →",
    ctaCompare: "比較路線選項",
    badges: ["班夫 ⇄ 賈斯珀路線","可加購哥倫比亞冰原","可加購瑪琳湖遊船","可加購 Hinton 延伸","依星期出發"],
    sideEyebrow: "— 依出遊日選擇",
    sideTitle: "選擇你的出遊日",
    sideCtaContinue: "前往預訂 →",
    weekendNote: "週末加價:週五、週六、週日的基本票價將自動加收每人 $20。",
    cards: [
      { day: "週一 / 週五", title: "班夫 → 賈斯珀觀光接駁", from: "成人 $200 起 / 兒童 $140 起", accent: "north" },
      { day: "週二 / 週六", title: "賈斯珀、瑪琳湖、班夫分段組合", from: "每段 $130 起", accent: "split" },
      { day: "週三 / 週日", title: "賈斯珀 → 班夫觀光接駁", from: "成人 $220 起 / 兒童 $160 起", accent: "south" },
    ],
  },
  finder: {
    eyebrow: "— 快速路線搜尋",
  ...
  why: {
    eyebrow: "— 為什麼這條路線不一樣",
    heading: "在班夫、賈斯珀、Hinton 與冰原大道之間更聰明的旅行方式",
    items: [
  ...
  overview: {
    ...
    heading: "依出發日整理的路線總覽",
    groups: [
      { day: "週一 / 週五", title: "班夫 → 賈斯珀觀光接駁", dur: "約 9 小時", bestFor: "從班夫前往賈斯珀,想要沿途觀光並可加購哥倫比亞冰原體驗的旅客。", accent: "north",
        lines: [["基本票價","成人 $200 / 兒童 $140"],["哥倫比亞冰原雪車","成人 +$90 / 兒童 +$60"],["Hinton 延伸","單程 +$20 / 來回 +$35"],["接送","08:00 Moxy Banff · 08:03 Best Western · 08:10 Mountain Royal"],["下車","17:10 賈斯珀車站 · 18:30 Hinton(含延伸)"]] },
      { day: "週二 / 週六", title: "分段產品", dur: "彈性 5 小時分段", bestFor: "需要在一日內彈性組合賈斯珀、班夫、Hinton 與瑪琳湖的旅客。", accent: "split",
        lines: [["2A — 賈斯珀 / 瑪琳湖一日","09:20 – 16:40 · $160 / 人 · 遊船 +$100/$70"],["2B — 賈斯珀 → 班夫快速","17:00 – 22:00 · $130 / 人"],["3A — 班夫 → 賈斯珀快速","08:00 – 13:00 · $130 / 人 · Hinton +$20/$35"],["3B — 藥湖 & 瑪琳湖半日","13:00 – 18:00 · $160 / 人 · 遊船 +$100/$70"]] },
      { day: "週三 / 週日", title: "賈斯珀 → 班夫南下觀光", dur: "約 10 小時", bestFor: "從賈斯珀回到班夫,沿冰原大道完整觀光的旅客。", accent: "south",
        lines: [["基本票價","成人 $220 / 兒童 $160"],["哥倫比亞冰原雪車","成人 +$90 / 兒童 +$60"],["Hinton 接送","單程 +$20 / 來回 +$35"],["接送","07:50 Hinton(加購) · 09:00 賈斯珀車站"],["下車","18:50 Mountain Royal 或班夫鎮指定飯店"]] },
    ],
  },
  detailed: {
    eyebrow: "— 詳細行程",
  ...
  reserve: {
    ...
    combo2: "全日:賈斯珀 / 瑪琳湖 / 班夫組合",
    combo3: "全日:班夫 / 賈斯珀 / 瑪琳湖組合",
  ...
  compare: {
    ...
    rows: [
      { id: "P1", addons: "冰原 · Hinton" },
      { id: "P2A", addons: "瑪琳湖遊船" },
      { id: "P2B", addons: "無" },
      { id: "P3A", addons: "Hinton 延伸" },
      { id: "P3B", addons: "遊船 · Hinton" },
      { id: "P4", addons: "冰原 · Hinton 接送" },
    ],
    pp: "/人",
  },
  addonsSection: {
  ...
  pickupNotes: {
    ...
    cards: [
      ...
      { t: "賈斯珀接送", lines: ["賈斯珀車站為大部分路線的主要接送點。"] },
  ...
  included: {
    ...
    included: ["舒適的交通車輛","依路線安排的上下車服務","沿途景觀公路交通","觀光路線的計畫停點","串聯班夫、賈斯珀、Hinton、冰原大道、藥湖與瑪琳湖的路線安排","流星雨假期的訂單支援"],
  ...
  faq: {
    ...
    heading: "重要旅遊資訊",
    items: [
      { q: "需要加拿大國家公園通行證嗎？", a: "需要。進入班夫或賈斯珀國家公園的旅客可能需要有效的 Parks Canada 通行證,除非另有說明,通行證並不包含於團費內。" },
      ...
      { q: "可以自選飯店接送嗎？", a: "部分路線使用固定接送點。班夫與賈斯珀的飯店接送可能有限制,最終接送細節將於預訂後確認。" },
...
const KO: IcefieldsContent = {
  ...
  compare: {
    ...
    rows: [
      { id: "P1", addons: "아이스필드 · 힌튼" },
      { id: "P2A", addons: "말린 호수 크루즈" },
      { id: "P2B", addons: "없음" },
      { id: "P3A", addons: "힌튼 연장" },
      { id: "P3B", addons: "크루즈 · 힌튼" },
      { id: "P4", addons: "아이스필드 · 힌튼 픽업" },
    ],
    pp: "/인",
  },
  addonsSection: {
