...
export const LAKE_TOURS_EN: LakeToursContent = {
  ...
  tours: [
    ...
    },
    {
      ...
      short: "Skip the Banff transfer — depart directly from Calgary for Moraine Lake and Lake Louise in one full day. Now 30% off during the Calgary Stampede.",
      priceFromLabel: "From $100 CAD",
      duration: "Full day",
...
export const LAKE_TOURS_ZH: LakeToursContent = {
  ...
  tours: [
    ...
    },
    {
      ...
      slug: "moraine-lake-lake-louise-calgary-departure",
      name: "夢蓮湖 & 露易絲湖 — 卡加立出發",
      short: "免去到班夫的接駁，直接從卡加立出發，一日走訪夢蓮湖與露易絲湖。卡加立牛仔節期間 30% 折扣。",
      priceFromLabel: "$100 CAD 起",
      duration: "一日",
      departure: "卡加立上午",
...
export const LAKE_TOURS_KO: LakeToursContent = {
  ...
  tours: [
    ...
    },
    {
      ...
      short: "밴프까지 이동할 필요 없이 캘거리에서 바로 출발해 하루에 모레인 호수와 레이크 루이스를 만나는 투어. 캘거리 스탬피드 기간 30% 할인.",
      priceFromLabel: "$100 CAD 부터",
      duration: "종일",
      departure: "캘거리 오전",
