...
export const reviews: Review[] = [
  ...
  {
    avatar: g2, name: "金賢宇", country: "釜山, KR", tour: "黃刀鎮極光追蹤", rating: 5,
    text: "−32 度。真的。第一晚因為雲層完全沒看到，第三天凌晨兩點導遊把我們叫醒，出去一看天空整片在發綠光。一輩子都不會忘記。",
    photos: [ykPolas, ykBg, tourAurora, destYukon],
  },
  {
    avatar: g1, name: "James Patel", country: "素里, CA", tour: "極光追蹤之旅", rating: 5,
