...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    title: "哥倫比亞冰原大道",
    desc: "冰原雪車・天空步道・弓湖",
    intro: "走上千年冰川，俯瞰落磯山的時光斷面。",
    duration: "1 日 (從班夫出發)",
    group: "小團 8–14 人",
    language: "中文 / 英文",
    price: "CAD $199 起",
    itinerary: [
      { stop: "07:30", title: "班夫出發", body: "沿冰原大道北上。" },
      { stop: "10:00", title: "弓湖・鴉爪冰川", body: "停留拍照觀景。" },
      { stop: "12:30", title: "冰原雪車體驗", body: "登上千年阿薩巴斯卡冰川。" },
      { stop: "14:30", title: "天空步道", body: "玻璃步道俯瞰深谷。" },
      { stop: "18:30", title: "返回班夫", body: "結束行程。" },
    ],
    included: ["冰原雪車門票", "天空步道門票", "全程交通", "中文導遊"],
    bring: ["保暖外套", "防滑鞋", "墨鏡"],
    notes: ["冰原天氣寒冷，請務必保暖"],
    faq: [{ q: "適合年長者嗎？", a: "雪車有階梯，行動需自如；天空步道平緩。" }],
  },
  {
