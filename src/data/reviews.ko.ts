...
export const reviews: Review[] = [
  {
    avatar: g2, name: "이민준", country: "서울, KR", tour: "밴프 & 루이스 호수", rating: 5,
  ...
  {
    avatar: g1, name: "Sarah Thompson", country: "버나비, CA", tour: "밴프 1일 투어", rating: 5,
    text: "BC에 12년 살면서 밴프를 한 번도 못 가봤어요. 한국에서 오신 엄마랑 같이 1일 투어를 했는데 — 소규모, 안 서두르고, 가이드가 빛이 가장 좋은 시간을 정확히 알고 있더라고요. 엄마가 아직도 그 얘기만 하세요.",
    photos: [b1, b5, lake13],
  },
  {
    avatar: g3, name: "강지원", country: "대전, KR", tour: "로키 마운틴 클래식", rating: 5,
  ...
  {
    avatar: g1, name: "Marcus Chen", country: "리치먼드, CA", tour: "시애틀 주말 여행", rating: 5,
  ...
  {
    avatar: g2, name: "한소연", country: "인천, KR", tour: "시애틀 주말 여행", rating: 4,
  ...
  {
    avatar: g3, name: "린쟈잉", country: "밴쿠버, CA", tour: "빅토리아 & 부차트 가든", rating: 5,
  ...
  {
    avatar: g2, name: "최유나", country: "대구, KR", tour: "빅토리아 가든 여정", rating: 5,
    text: "엄마랑 둘이 다녀왔어요. 페리에서 본 바다, 부차트 가든의 장미 정원, 그리고 작은 카페에서 먹은 스콘까지 — 하루가 너무 짧게 느껴졌어요. 가이드님이 한국어로 꼼꼼히 설명해주셔서 편안했습니다.",
    photos: [v1, v5, v8, v4],
  },

  {
    avatar: g3, name: "천쥔훙", country: "타이베이, TW", tour: "밴쿠버 시티 디프 다이브", rating: 5,
  ...
  {
    avatar: g2, name: "김현우", country: "부산, KR", tour: "옐로나이프 오로라 체이스", rating: 5,
  ...
  {
    avatar: g1, name: "James Patel", country: "써리, CA", tour: "오로라 체이스 여정", rating: 5,
