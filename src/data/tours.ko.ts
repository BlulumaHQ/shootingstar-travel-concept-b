...
const LANGUAGE_NOTE =
  "【가이드 및 언어 안내】 본 투어는 한국어, 영어, 중국어 3개 국어 오디오 가이드를 기본으로 제공하며, 드라이버 겸 가이드가 현장에서 주요 포인트를 함께 설명해 드립니다. 드라이버가 실제로 사용하는 해설 언어는 당일 탑승 게스트 구성에 따라 유연하게 조정됩니다. 최대한 원하시는 언어를 반영해 드리기 위해 노력하지만, 단일 언어 전용 투어를 보장해 드릴 수는 없는 점 양해 부탁드립니다.";
const ROOM_NOTE =
